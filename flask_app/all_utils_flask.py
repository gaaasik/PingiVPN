...
# Пример вызова функций обновления статуса (замените на реальные функции)
    ...
    try:
        async with aiosqlite.connect(DATABASE_PATH) as connection:
            ...
            if payment_exists:
                ...
                logging.info(f"Добавлен новый платеж: ID {payment_id}, пользователь {user_id}, сумма {amount} {currency}.")
