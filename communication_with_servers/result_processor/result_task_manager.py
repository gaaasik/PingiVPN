...
from communication_with_servers.result_processor.all_processor.result_update_and_reboot_server import \
    UpdateAndRebootServer
...
class ResultTaskManager:
    def __init__(self, redis_client):
        self.task_handlers = {
            ...
            "result_update_and_reboot_server": UpdateAndRebootServer(redis_client)
        }
