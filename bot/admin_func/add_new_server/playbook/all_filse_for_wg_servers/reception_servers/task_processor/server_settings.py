...
class ServerSettings:
    ...
    PATH_DATABASE_X_UI = os.getenv("path_database_x_ui").strip()
    PATH_PRIMARY_WG_JSON = os.getenv("path_primary_wg_json").strip()
    PATH_PRIMARY_WG_CONFIG = os.getenv("path_primary_wg_config").strip()
    ALTERNATE_WG_CONFIG_PATH = os.getenv("path_alternate_wg_config").strip()
