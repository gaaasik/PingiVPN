...
from bot.keyboards.reply import reply_keyboard, reply_keyboard_main_menu
...
async def send_cached_photo(message):
    ...
    if cached_photo:
        await message.answer_photo(photo=cached_photo, reply_markup=reply_keyboard_main_menu)
    else:
