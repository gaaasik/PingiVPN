...
share_message = (
    "🎉 Наш VPN-сервис действительно работает на отлично! Скорость быстрая, а защита надежная! 🚀\n"
    "Поделитесь этим ботом с другом, чтобы они тоже могли воспользоваться нашим супер сервисом! 💪"
)
